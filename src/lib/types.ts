 ...
 * السماع **على كلامٍ مسموع** حُكم بقياس الصوت وحده (كما يُحكم بالميكروفون بلا
 * سماعٍ ذكي)، ويُصرَّح للقارئ بأن اللفظ لم يُتحقَّق منه. أمّا إذا سمِع السماعُ
 * لفظًا فخالف الآية فلا اجتياز: تلك مخالفةٌ مقيسة لا إخفاق. وكذلك إن لم يُسمع
 * في التسجيل كلامٌ أصلًا (`nospeech`): فلا تُجاز أزمنةٌ اختُلقت من ضجيج.
 */
